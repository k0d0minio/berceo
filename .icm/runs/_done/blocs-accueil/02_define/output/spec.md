...
- Colours: the inks, the dark surfaces and the platform-wide tokens (D-1, D-2, D-3; encres-contraste, merged in k0d0minio/berceo#43). The header and the hero, the H1's line count included (D-6; premier-ecran, merged in k0d0minio/berceo#46).
- The image bank's PNGs (D-7, a parked chore) and how the scope landed on main (D-8): not this run's.
