...
- none — the two choices the stub left open were settled with the operator on 2026-09-26: `redirectTo` uses `siteUrl`, not dropped (D-149), and the query reaches the guard through its callers, not a proxy header (D-150).
